...
cp agent_ngsi.conf.template agent_ngsi_sth-comet.conf
cp cygnus_instance.conf.template cygnus_instance_sth-comet.conf

echo "Please edit agent_ngsi_sth-comet.conf and cygnus_instance_sth-comet.conf files in "$FLUME_HOME/conf" folder according to your STH Comet instance" 
