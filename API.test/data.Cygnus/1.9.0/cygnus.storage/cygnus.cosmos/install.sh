...
cp agent_ngsi.conf.template agent_ngsi_cosmos.conf
cp cygnus_instance.conf.template cygnus_instance_cosmos.conf

echo "Please edit agent_ngsi_cosmos.conf and cygnus_instance_cosmos.conf files in "$FLUME_HOME/conf" folder according to your Cosmos instance" 
