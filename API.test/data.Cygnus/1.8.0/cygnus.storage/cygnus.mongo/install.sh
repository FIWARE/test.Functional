...
cp agent_ngsi.conf.template agent_ngsi_mongo.conf
cp cygnus_instance.conf.template cygnus_instance_mongo.conf

echo "Please edit agent_ngsi_mongo.conf and cygnus_instance_mongo.conf files in "$FLUME_HOME/conf" folder according to your mongo db instance" 
