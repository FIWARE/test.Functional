...
function get_token () {
    ...
    CLIENT_ID="47f2b4ba09814537b725bbc63b695027"
    CLIENT_SECRET="45556a2f298349a498a974e3714d2d8a"
    ...
    REQUEST="curl -s --insecure -i --header ${AUTH_BASIC} --header ${CONTENT_TYPE} -X POST http://localhost:8000/oauth2/token -d ${DATA}"
