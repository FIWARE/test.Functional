...
# npm start # this is a simple start with localhost and port 3000
# use public IP to configure the activation via email - set IDM_HOST before to start
PUBLIC_IP="$(dig +short myip.opendns.com @resolver1.opendns.com)"
IDM_HOST=http://$PUBLIC_IP:3000 
npm start
