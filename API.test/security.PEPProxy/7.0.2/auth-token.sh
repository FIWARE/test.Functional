...
function get_token () {
    ...
    CLIENT_ID="6309bdc4-37c3-4d52-9891-b8c805804588"
    CLIENT_SECRET="58cfdc04-6560-46a2-81f1-f6a79fb79fbd"
    ...
    REQUEST="curl -s --insecure -i --header ${AUTH_BASIC} --header ${CONTENT_TYPE} -X POST http://keyrock:3000/oauth2/token -d ${DATA}"
